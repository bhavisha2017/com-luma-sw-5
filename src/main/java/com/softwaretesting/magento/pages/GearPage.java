...
public class GearPage extends Utility {
    ...
    {
        Reporter.log("Click on bags"+clickOnBag);
    ...
    {
        Reporter.log("Click on Product Name ‘Overnight Duffle’"+overnightDuffle);
    ...
    {
        Reporter.log("Verify the text ‘Overnight Duffle’"+verifyOverNightDuffle);
    ...
    {
        Reporter.log("Change Qty 3"+changeQty);
      clearQty(clearQty);
    ...
    {
        Reporter.log("Verify the text ‘You added Overnight Duffle to your shopping cart."+ verifyShoppingCart);
    ...
    {
        Reporter.log("Click on ‘shopping cart’ Link into message"+shoppingCartMessage);
    ...
    {
        Reporter.log("Verify the Qty"+verifyQty3);
    ...
    {
        Reporter.log("Veryfy the product price"+ productPrice$135);
    ...
    {
        Reporter.log(""+updateShoppingCart);
    ...
    {
        Reporter.log("Verify the product price"+ productPrice$225);
